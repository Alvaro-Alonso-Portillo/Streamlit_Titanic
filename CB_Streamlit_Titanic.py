...
st.set_page_config(
    page_title = 'Alvaro Alonso - Titanic',
    page_icon = '🧊',
    layout = 'wide',
...
def page_1():
    st.subheader('🚢 Descripcion de Datos')
    st.markdown(
        open(r'./html_Titanic_tabla_descripcion.html').read(),
        unsafe_allow_html = True,
    )
    with st.expander('Marco de Datos'):
...
pg = st.navigation(
    {'D&A': [
        ...
        st.Page(page_2, title = 'Analisis de Datos', icon = '📈'),
        ],
